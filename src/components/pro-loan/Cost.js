      ...
      <div>
        <div className="w-full flex lg:flex-row flex-col justify-start items-center lg:my-10">
          <div className="lg:w-1/2 w-full lg:mr-5 lg:my-0 my-2">
            <p className="text-left font-bold mb-5">Official Phone Number</p>
            <TextField
              value={amountValue}
        ...
        <div className="w-full flex lg:flex-row flex-col justify-start items-center lg:my-10">
          <div className="lg:w-1/2 w-full lg:mr-5 lg:my-0 my-2">
            <p className="text-left font-bold mb-5">CAC Document</p>
            <TextField
              value={amountValue}
              changeText={changeLoanAmount}
              type="file"
        ...
        <div className="w-full flex lg:flex-row flex-col justify-start items-center lg:my-10">
          <div className="lg:w-1/2 w-full lg:mr-5 lg:my-0 my-2">
            <p className="text-left font-bold mb-5">Primary Provider Practional License Number</p>
            <TextField
              value={amountValue}
              changeText={changeLoanAmount}
              type="number"
