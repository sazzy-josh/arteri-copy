        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectDash ? "#3385D7" : "#ffffff"}
        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectApplication ? "#3385D7" : "#ffffff"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectAccount ? "#3385D7" : "#ffffff"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectHistory ? "#3385D7" : "#ffffff"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectClaims ? "#3385D7" : "#ffffff"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
        ...
        >
          <span>
            <svg
              ...
              viewBox="0 0 24 24"
              fill="none"
              stroke={selectHelp ? "#3385D7" : "#ffffff"}
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
